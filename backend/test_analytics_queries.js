...
async function testAnalytics() {
    try {
        ...
        console.log('KPI Result:', kpiResult.recordset[0]);
        ...
        `;
        const chartResult = await pool.request().input('days', sql.Int, days).query(chartQuery);
        console.log('Chart Rows:', chartResult.recordset.length);
        ...
        console.table(lowStockResult.recordset);
